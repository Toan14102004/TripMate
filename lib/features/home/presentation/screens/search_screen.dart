                        ...
                        child: Wrap(
                          ...
                          children: [
                            _FilterChip(
                              ...
                              onTap: () {
                                setModalState(() {
                                  _selectedOrderBy = _selectedOrderBy == 'newest' ? null : 'newest';
                                });
                              },
                            ),
                            _FilterChip(
                              ...
                              onTap: () {
                                setModalState(() {
                                  _selectedOrderBy = _selectedOrderBy == 'rating' ? null : 'rating';
                                });
                              },
                            ),
                            _FilterChip(
                              ...
                              onTap: () {
                                setModalState(() {
                                  _selectedOrderBy = _selectedOrderBy == 'booking' ? null : 'booking';
                                });
                              },
                            ),
                          ],
                        ...
                        child: Wrap(
                          ...
                          children: [
                            _FilterChip(
                              ...
                              onTap: () {
                                setModalState(() {
                                  _selectedDomain = _selectedDomain == 'mb' ? null : 'mb';
                                });
                              },
                            ),
                            _FilterChip(
                              ...
                              onTap: () {
                                setModalState(() {
                                  _selectedDomain = _selectedDomain == 'mt' ? null : 'mt';
                                });
                              },
                            ),
                            _FilterChip(
                              ...
                              onTap: () {
                                setModalState(() {
                                  _selectedDomain = _selectedDomain == 'mn' ? null : 'mn';
                                });
                              },
                            ),
                          ],
                        ...
                        child: Wrap(
                          ...
                          children: [
                            _FilterChip(
                              ...
                              onTap: () {
                                setModalState(() {
                                  _selectedTime = _selectedTime == '1 ngày' ? null : '1 ngày';
                                });
                              },
                            ),
                            _FilterChip(
                              ...
                              onTap: () {
                                setModalState(() {
                                  _selectedTime = _selectedTime == '2 ngày 1 đêm' ? null : '2 ngày 1 đêm';
                                });
                              },
                            ),
                            _FilterChip(
                              ...
                              onTap: () {
                                setModalState(() {
                                  _selectedTime = _selectedTime == '3 ngày 2 đêm' ? null : '3 ngày 2 đêm';
                                });
                              },
                            ),
                            _FilterChip(
                              ...
                              onTap: () {
                                setModalState(() {
                                  _selectedTime = _selectedTime == '4 ngày 3 đêm' ? null : '4 ngày 3 đêm';
                                });
                              },
                            ),
                          ],
                        ...
                        child: Wrap(
                          ...
                          children: [
                            _FilterChip(
                              ...
                              onTap: () {
                                setModalState(() {
                                  _selectedDestination = _selectedDestination == 'Đà Lạt' ? null : 'Đà Lạt';
                                });
                              },
                            ),
                            _FilterChip(
                              ...
                              onTap: () {
                                setModalState(() {
                                  _selectedDestination = _selectedDestination == 'Hà Nội' ? null : 'Hà Nội';
                                });
                              },
                            ),
                            _FilterChip(
                              ...
                              onTap: () {
                                setModalState(() {
                                  _selectedDestination = _selectedDestination == 'Hội An' ? null : 'Hội An';
                                });
                              },
                            ),
                            _FilterChip(
                              label: 'Nha Trang',
                              isSelected: _selectedDestination == 'Nha Trang',
                              onTap: () {
                                setModalState(() {
                                  _selectedDestination = _selectedDestination == 'Nha Trang' ? null : 'Nha Trang';
                                });
                              },
                            ),
                            _FilterChip(
                              label: 'Phú Quốc',
                              isSelected: _selectedDestination == 'Phú Quốc',
                              onTap: () {
                                setModalState(() {
                                  _selectedDestination = _selectedDestination == 'Phú Quốc' ? null : 'Phú Quốc';
                                });
                              },
                            ),
                            _FilterChip(
                              ...
                              onTap: () {
                                setModalState(() {
                                  _selectedDestination = _selectedDestination == 'Sapa' ? null : 'Sapa';
                                });
                              },
                            ),
                          ],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.transparent,
        elevation: 0,
        title: Text('All Packages', style: TextStyle(color: isDark ? AppColors.white : AppColors.black),),
        centerTitle: true,
        actions: [
          Stack(
            children: [
